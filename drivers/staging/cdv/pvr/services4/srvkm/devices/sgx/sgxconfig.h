...
#define SGX_KERNEL_DATA_HEAP_OFFSET		0x00000000
	...
	/* XXX put general heap to highest address that suppose more '1's is less common in 
	 * bad address, currently limit size to 256M though.*/
	#define SGX_GENERAL_HEAP_BASE				 0xF0000000
	#define SGX_GENERAL_HEAP_SIZE				(0x10000000-0x00001000)
