/* drivers/net/ksz846x.h - Micrel KSZ846X definition file
 *
...
#define P_PRIORITY_CTRL			REG_PORT_CTRL1
...
#define S_802_1P_PRIORITY_CTRL		REG_SWITCH_CTRL_6
#define S_UNKNOWN_DA_CTRL		REG_SWITCH_CTRL_7
#define S_TOS_PRIORITY_CTRL		REG_TOS_PRIORITY_CTRL_1
