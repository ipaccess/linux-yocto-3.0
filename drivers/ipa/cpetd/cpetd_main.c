 ...
 *
 * $Id: PC202/kernel/kernel-2.6.34/linux-v2.6.34-ipa-4.0.6-patch 1.20.2.2 2012/11/30 11:19:54GMT ih3 Exp  $
 */
...
#if defined(CPETD_ON_ARM)
/* use the RTC free running timer */

#  if defined(CONFIG_ARCH_FIRECRACKER)

#    define TIMER_REG_BASE   PC20X_RTC_CLK_BASE
#    define TIMER_REG_OFFSET RTC_CURRECT_COUNTER_VALUE_REG_OFFSET

#  elif defined(CONFIG_ARCH_PC3XX)

#    define TIMER_REG_BASE   PC302_RTCLK_BASE
#    define TIMER_REG_OFFSET RTCLK_CCV_REG_OFFSET

#  elif defined(CONFIG_ARCH_PICOXCELL)

#    define TIMER_REG_BASE   PICOXCELL_RTCLK_BASE
#    define TIMER_REG_OFFSET RTCLK_CCV_REG_OFFSET
...
#  define TIMER_VAL_REG    (IO_ADDRESS(TIMER_REG_BASE + TIMER_REG_OFFSET))
...
#elif defined(CONFIG_ARCH_PICOXCELL)
        cpetdHiresResolution = CLOCK_TICK_RATE;
#else
#  error "Unknown architecture"
#endif
